//promt for exercise Part 4 "introduces testing and authentication"
...
app.post("/api/books", (req, res, next) => {
  ...
  if (!body.title || !body.author || !body.year || !body.read) {
...
app.put("/api/books/:id", (req, res, next) => {
  ...
  BooKApi.findById(req.params.id).then((bookRecord) => {
    if (!bookRecord) {
...
app.delete("/api/books/:id", (req, res, next) => {
  BooKApi.findByIdAndDelete(req.params.id).then((bookRecord) => {
    res.status(204).end();
  });
});
